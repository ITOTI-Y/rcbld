...
{
    public class SolarCalculateBeamNew : GH_Component
    {
        public SolarCalculateBeamNew() : base("SolarCalculateBeam", "SolarData", "SolarData", "RCBldGH", "Test") { }

        public override Guid ComponentGuid => new Guid("{a6f112c4-4cf9-491f-8dca-d352890d92fd}");
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            GH_Surface SolarSurface = new GH_Surface();
            DA.GetData(1, ref SolarSurface);
