...
{
    public class SolarCalculateBeam:GH_Component
    {
        public SolarCalculateBeam(): base("SolarCalculateBeam", "SolarData", "SolarData", "RCBldGH", "Other"){}
        
        public override Guid ComponentGuid => new Guid("{bae94c80-7862-410f-abfd-c832152fdf11}");
