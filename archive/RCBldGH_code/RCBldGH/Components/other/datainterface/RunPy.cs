...
{
    public class RunPyComp : GH_Component
    {
        public RunPyComp() : base("RunPy", "Run", "Run", "RCBldGH", "7.Simulation")
        {
        }
        public override Guid ComponentGuid => new Guid("{67ad8869-e781-4da0-84dd-b6369142b74e}");
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            //    GH_ParamAccess.item);
            pManager.AddBooleanParameter("RunPy", "Run", "Run", GH_ParamAccess.item, false);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            bool isRun = false;
            if (!DA.GetData("RunPy", ref isRun) || !isRun)
            {
                return;
            }
            ...
            string RCBldEngExe = RCBldEngPath + @".\RCBldEng.py";
           ...
           // }
            ...
            cmd.cmdStr = cmdPara;
            Thread thread = new Thread(cmd.Run);
            thread.Start();
