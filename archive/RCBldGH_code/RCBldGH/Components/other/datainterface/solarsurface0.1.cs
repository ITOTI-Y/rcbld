...
{
    public class MaterialAssignRadianceComp : GH_Component
    {
        public MaterialAssignRadianceComp() : base("Solarsurface_old", "Material to Brep", "Assignment MaterialSetting to breps", "RCBldGH", "Other")
        {
        }
        public override GH_Exposure Exposure => GH_Exposure.primary;
        public override Guid ComponentGuid => new Guid("{0b34206c-d5d1-457e-89d9-ec937a27a733}");
        ...
        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            ...
            pManager.AddSurfaceParameter("suface", "setting", "Envelope setting", GH_ParamAccess.tree);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DataTree<Surface> RadSurface = new DataTree<Surface>();
                ...
                for (int j = 0; j < prTree.Branch(prTree.Paths[i]).Count; j++)//每个面
                {
                    if (prTree[prTree.Paths[i], j].RelativePosition == 0)//若为顶面
                    {
                        ...
                        if (isExter)
                        {
                            ...
                            RadSurface.Add(prTree[prTree.Paths[i], j].Surface, prTree.Paths[i]);
                        }
                    }//top
