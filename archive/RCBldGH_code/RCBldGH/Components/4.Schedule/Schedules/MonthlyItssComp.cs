...
{
    public class MonthlyItssComp : GH_Component
    {
        public MonthlyItssComp()
            : base("Monthly ITSS", "MonthlyItss",
                "Monthly Indoor Temperature Setpoint Schedule. ",
                "RCBldGH", "4.Schedules")
        {
        }

        public override Guid ComponentGuid => new Guid("{06636C80-DA79-4F83-8E5F-CA98A2C64FC1}");
        protected override System.Drawing.Bitmap Icon => RCBldGH.Properties.Resources.Schedule_itss;
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Indoor Temperature Setpoint Schedules", "ITSS", "Specify the Indoor Temperature Setpoint Schedule for each month.", GH_ParamAccess.list);
        }

        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            pManager.AddGenericParameter("Schedule", "S", "Monthly Indoor Temperature Setpoint Schedule", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            for (int i = 0; i < timespans.Count; i++)
            {
                ...
                if (relatedSchedule.ScheduleType != ScheduleType.Basic)
                {
                    this.AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "At least one schedule is not Indoor Temperature Setpoint Schedule.");
                    return;
                }
            ...
            {
                ScheduleType = ScheduleType.MonthlyItss,
                Name = name,
