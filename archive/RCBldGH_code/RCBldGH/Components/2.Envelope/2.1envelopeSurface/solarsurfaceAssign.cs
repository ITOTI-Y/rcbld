...
{
    public class SolarSurface2Comp : GH_Component
    {
        public SolarSurface2Comp() : base("SolarsurfaceAssign", "Material to Brep", "Assignment MaterialSetting to breps", "RCBldGH", "2.Envelops")
        {
        }
        public override GH_Exposure Exposure => GH_Exposure.primary;
        public override Guid ComponentGuid => new Guid("{5b3404ae-1e4b-4eaf-9d6f-e72e265d1fcb}");
